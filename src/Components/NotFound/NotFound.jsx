...
const NotFound = () => {
    return (
        ...
        <div className="container flex flex-col items-center justify-center px-5 mx-auto my-8 space-y-8 text-center sm:max-w-md">
            ...
            <p className="text-6xl font-bold">Please Login</p>
            <a rel="noopener noreferrer" href="/" className="px-8 py-3 font-semibold rounded btn bg-[#5BC0EB] text-white">GO to Homepage</a>
        </div>
    </section>
    );
};
